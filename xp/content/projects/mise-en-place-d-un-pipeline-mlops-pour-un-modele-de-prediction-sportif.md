...
draft: false
slug: parivision
tags: ["mlops", "python", "webinaire","conteneurisation", "database", "ci-cd", "datascience", "management", "mlflow", "etl", "supervision"]
...
> [https://www.youtube.com/live/oRQVMk-P8m4?si=TXQmSGEpBpgfRkOJ](https://www.youtube.com/live/BKseQLFiYhU?si=Qorv0EB_CxDvhGcr&t=4044)

## Rapport de projet

[Un rapport détaillé du projet est disponible sur GitHub](https://github.com/heuzef/DEC24_MLOPS_PARIS_SPORTIFS/blob/main/reports/parivision_report.pdf), couvrant toutes les étapes du projet, de l'exploration des données à l'exploitation et la supervision de l'application.
